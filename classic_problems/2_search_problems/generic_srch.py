...
def linear_srch(iterable: Iterable[T], key: T) -> bool:
...
def binary_srch(sequence: Sequence[C], key: C) -> bool: 
    low: int = 0
...
if __name__ == "__main__":
    print(linear_srch([1, 5, 15, 15, 15, 15, 20], 5)) # True 
    print(binary_srch(["a", "d", "e", "f", "z"], "f")) # True 
    print(binary_srch(["john", "mark", "ronald", "sarah"], "sheila")) #False
"""